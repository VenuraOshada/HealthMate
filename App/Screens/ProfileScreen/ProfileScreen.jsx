...
export default function ProfileScreen() {
 ...
 const profileMenu=[
  ...
  return (
    <View>
    <View style={{padding:20,paddingTop:30, backgroundColor:Colors.WHITE}}>
     <Text style={{fontSize:30,fontFamily:'outfit-bold',color:Colors.BLACK}}>Profile</Text>
      <View style={{
        display:'flex',
      ...
      color:Colors.BLACK}}>{user.fullName}</Text>
    ...
    <View style={{paddingTop:60}}>
      ...
      renderItem={({item,index})=>(
        ...
        paddingHorizontal:80,
          ...
          <Ionicons name={item.icon} size={35} color={Colors.BLACK} />
